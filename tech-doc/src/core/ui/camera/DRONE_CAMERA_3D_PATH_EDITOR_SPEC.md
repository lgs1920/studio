...
path runtime described in [Drone camera path architecture](DRONE_CAMERA_PATH_ARCHITECTURE.md).
...
- [Drone camera path architecture](DRONE_CAMERA_PATH_ARCHITECTURE.md)
