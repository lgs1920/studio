...
vi.mock('@Components/Flythrough/FlythroughButton', () => ({
    FlythroughButton: () => <div data-testid="flythrough-launch-button"/>,
}))
vi.mock('@Components/Flythrough/FlythroughControlsWidget', () => ({
    FlythroughControlsWidget: () => <div data-testid="flythrough-controls"/>,
}))
vi.mock('@Components/Flythrough/FlythroughDrawer', () => ({
    FlythroughDrawer: () => <div data-testid="flythrough-drawer"/>,
}))
...
vi.mock('@Components/CallForActions', () => ({
    CallForActions: () => <div data-testid="call-for-actions"/>,
}))

import { MainUI } from '@Components/MainUI/MainUI'

describe('MainUI flythrough mask', () => {
    beforeEach(() => {
        globalThis.__ = {
            app: {
    ...
    it('hides the main UI but keeps the flythrough toolbar visible while running', () => {
