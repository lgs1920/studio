  ...
  <trk>
    ...
    it('recenters on the current journey when stopping an active flythrough', () => {
        ...
        try {
            ...
            expect(globalThis.lgs.stores.flythrough.orbitAllowed).toBe(false)
            mode.stop()
            ...
            expect(globalThis.lgs.stores.flythrough.orbitAllowed).toBe(true)
    ...
    it('closes POIs opened by flythrough before running stop clips', async () => {
        const journey = makeJourney([
            makeTrack({
                slug:        'track#journey#gpx#main',
                coordinates: [[2, 48, 120], [2.001, 48.001, 130]],
    ...
    it('zoomin starts high and descends to the flythrough altitude', async () => {
        vi.useFakeTimers()
        const journey = makeJourney([
                                        makeTrack({
                                                      slug:        'track#journey#gpx#main',
        ...
        journey.flythrough.start = [zoomIn]
