...
describe('ReplayTimelinePreview', () => {
    ...
    it('renders the existing Replay projection with the Web Component interactions enabled', async () => {
        ...
        expect(timelineElement.querySelector('[slot="timeline-controls"]')).toBeNull()
    ...
    it('restores and persists the horizontal zoom and playhead position', async () => {
        ...
        timelineElement.dispatchEvent(new CustomEvent('lgs1920-timeline-zoom-change', {
            bubbles: true,
            detail: {zoomPercent: 180},
        }))
