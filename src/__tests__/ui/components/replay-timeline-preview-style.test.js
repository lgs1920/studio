...
describe('Replay timeline preview styles', () => {
    ...
    it('uses valid nested selectors for the Web Component visual layers', () => {
        ...
        expect(splitPanelRule).toContain('grid-auto-flow: column;')
        expect(splitPanelRule).toContain('grid-template-columns: clamp(')
        ...
        expect(webComponentStyleSource.match(/box-shadow: var\(--wa-shadow-s\);/g)).toHaveLength(4)
        ...
        expect(webComponentStyleSource).toContain('--lgs-timeline-legend-min-width: 100px;')
        expect(webComponentStyleSource).toContain('--lgs-timeline-legend-max-width: 230px;')
