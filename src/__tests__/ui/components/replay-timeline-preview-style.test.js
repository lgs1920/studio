...
describe('Replay timeline preview styles', () => {
    ...
    it('uses valid nested selectors for the Web Component visual layers', () => {
        ...
        expect(webComponentStyleSource).toContain('color: var(--wa-color-warning-on-normal);')
        expect(webComponentStyleSource).toContain('background: var(--wa-color-warning-fill-normal);')
        expect(webComponentStyleSource).toContain('background-color: var(--wa-color-warning-fill-normal);')
