...
export const SHORTCUTS_CATALOG = [
    ...
    {
        action:      'Reduce or expand widget',
        description: 'Toggles a reducible on-map widget between its normal and compact states.',
    ...
    {
        action:      'Edit visual widget',
        description: 'Opens the editor for a visual widget that cannot be reduced.',
        id:          'widget-visual-edit',
        keys:        ['Double click', 'Double tap'],
        reference:   true,
        scope:       'Widget interaction',
    },
