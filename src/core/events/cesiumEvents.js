...
export const CESIUM_EVENTS = {
    ...
    // Touch events
    TAP:        {event: ScreenSpaceEventType.LEFT_DOWN, type: 'TAP', touch: true},
    DOUBLE_TAP: {event: ScreenSpaceEventType.LEFT_DOWN, type: 'DOUBLE_TAP', touch: true},
    LONG_TAP:   {type: 'LONG_TAP', event: null, touch: true},
