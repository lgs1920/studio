...
export class WidgetManager {
    ...
    /**
     * Retrieves the element ID from the data attribute
     * @param {HTMLElement} element - The DOM element
     * @returns {string|null} The element's ID
     */
     ...
     * @param {number} limit - The minimum time between executions in ms
    ...
    /**
     * Hides control box with a delay unless dragging or mouse is over
    ...
    /**
     * Sets up a DOM element as a widget
     * @param {HTMLElement} element - The DOM element
    ...
    /**
     * Updates crop zone ratio and dimensions
    ...
    /**
     * Applies crop dimensions to the overlay
     * @param {Object} config - Widget configuration
     */
    ...
    /**
     * Retrieves or creates widget configuration
     * @param {HTMLElement} element - The DOM element
     * @param {Object} initialConfig - Initial configuration
    ...
    retrieveConfig = (element, initialConfig = {}) => {
        ...
        if (!this.#widgets.has(elementId)) {
            ...
            this.#widgets.set(elementId, {
                ...
                group:                  initialConfig.group ?? null, // Added group property
            })
        }
        else {
    ...
    /**
     * Manages control box visibility
     * @param {Object} moveable - Moveable instance
     * @param {Function} setControlBoxProps - Function to set control box properties
     * @param {Object} _controlBoxTimer - Timer reference
     * @param {boolean} show - Whether to show control box
     * @param {boolean} isMouseOver - Whether mouse is over element
     */
    ...
    /**
     * Sets boundary status for widget
     * @param {HTMLElement} element - The DOM element
     * @param {Object} config - Widget configuration
    ...
    /**
     * Creates inner overlay for widget
     * @param {HTMLElement} element - The DOM element
     */
    ...
    /**
     * Gets widget configuration by ID
     * @param {string} elementId - The element ID
     * @returns {Object|undefined} Widget configuration
     */
    ...
    /**
     * Gets inner overlay for widget
     * @param {HTMLElement} element - The DOM element
     * @returns {HTMLElement|undefined} Overlay element
     */
    ...
    /**
     * Monitors container resize events
     * @param {Object} config - Widget configuration
     * @param {Function} setBounds - Function to set bounds
     * @param {Object} moveable - Moveable instance
     * @param {HTMLElement} element - The DOM element
