...
export const RotationWidget = memo(() => {
    ...
    return (
        <WaCard
            appearance="plain"
            className={`orbit-widget rotation-widget lgs-card on-map ${toolBar.fromStart ? 'from-start' : 'from-end'}`}
        ...
        >
            <div className="panorama-widget-header">
                ...
                <WaButton appearance="plain" size="small" variant="on-map" onClick={stopRotation}>
            ...
            <WaButton appearance="outlined" size="small" variant="on-map" onClick={stopRotation}>
