...
import { MOBILE_MAX }                                         from '@Core/constants'
...
export const RemoveJourney = (props) => {
    ...
    const toggleRemoveDialog = (event) => {
        if (mainUI.removeJourneyDialog.active) {
            hideRemoveDialog()
        }
        else {
            mainUI.removeJourneyDialog.active = true
                ...
                {props.style === 'button' &&
                    <>
                        ...
                        <SlPopup anchor={removeButton.current}
                                 active={snap.removeJourneyDialog.active}
                                 hover-bridge="true" shift="true"
                                 placement={(settings.toolBar.fromStart ? 'top-end' : 'top-start')}
                                 distance={distance}
                        >
