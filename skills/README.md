...
Compatibility links are kept at `.agents/skills`, `.aiassistant/skills`, and `agent/skills` for tools that discover
Skills through a provider-specific location. Do not edit those locations directly: add or update Skill content under
this directory.
