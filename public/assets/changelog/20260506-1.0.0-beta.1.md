...
- **Widget reduction and locking**: Scene widgets can now be reduced with double click and locked with Ctrl-click when enabled, with persisted state, context menu actions, and widget-specific icons.
